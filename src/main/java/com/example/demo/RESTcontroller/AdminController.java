...
@Tag(name = "Trip configuration", description = "This is a configuration page for Admin")
@RestController
@Slf4j
...
public class AdminController {
    ...
    @Operation(
            summary = "Add trip",
            description = "This is a POST endpoint to add trip by Admin."
    )
    @ApiResponses({
    ...
    @Operation(
            summary = "Edit trip",
            description = "This is a PUT endpoint for editing trip by Admin."
    )
    @ApiResponses({
            @ApiResponse(responseCode = "200", content = { @Content(schema = @Schema(implementation = TripDTO.class))}),
